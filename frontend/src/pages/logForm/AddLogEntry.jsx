...
const AddLogEntry = () => {
  ...
  useEffect(() => {
    if (formData.project) {
      ...
      setFormData((prev) => ({ ...prev, technicians: [] }));
    } else {
      setFilteredTechnicians([]);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const selectedProject = projects.find((p) => p._id === formData.project);
      await axios.post("http://localhost:3000/api/logEntries", {
        ...formData,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-gray-100 to-blue-100 py-10 px-4 flex flex-col items-center">
      <div className="w-full max-w-4xl flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-gray-800">Add Log Entry</h1>
        <button
          onClick={handleBack}
...
//   // Filter technicians based on selected project
//   useEffect(() => {
//     if (formData.project) {
//       const selectedProject = projects.find(p => p._id === formData.project);
//       if (selectedProject?.technicians?.length > 0) {
...
//         setFilteredTechnicians([]);
//       }
//       setFormData(prev => ({ ...prev, technicians: [] })); // reset technicians
//     } else {
//       setFilteredTechnicians([]);
//     }
//   }, [formData.project, projects, users]);
...
//   return (
//     <div className="p-6 max-w-1/2 mt-32 mx-auto bg-gray-100 rounded-md shadow-md">
//       <h2 className="text-xl font-semibold mb-4">Add Log Entry</h2>
